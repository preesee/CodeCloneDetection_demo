...
datafortrain=[]
datafortrain +=datarowsT4[:2000]
datafortrain +=datarowsT1[:2000]
datafortrain +=datarowsT2[:2000]
datafortrain +=datarowsMT3[:2000]
datafortrain +=datarowsST3[:2000]
...
#malstm.compile(loss='sparse_categorical_crossentropy', optimizer='adam', metrics=['accuracy', f1, recall,precision])
