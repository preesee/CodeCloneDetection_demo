...
attn_path = 'vis_2.mtx'
input_code = "None None config False False type name dtype False CudaNdarrayType dtype type dtype name dtype <EOS>"

# input_txt = 'x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21'
input_txt = "def <unk> name None dtype None if dtype is None dtype config <unk> CudaNdarrayType dtype dtype broadcastable False False False return type name <EOS>"
output_sentence = "return a symbolic 3-d variable ."

attn_code = np.zeros((7, 16))
attn_code_lines = []
...
showAttention(input_code, input_txt, output_sentence, attn_code, attn_txt, 'visual_att_2.pdf')
